...
$conn->query("insert into hiphop (choreography,performance,suitability,stage,total,group_num,judge_id,ranking)
	   values('$choreography_1','$performance_1','$suitability_1','$stage_1','$total1','$d1','$judge_id','$p1_rank')");		
 
$conn->query("insert into hiphop (choreography,performance,suitability,stage,total,group_num,judge_id,ranking)
	   values('$choreography_2','$performance_2','$suitability_2','$stage_2','$total2','$d2','$judge_id','$p2_rank')");		
 
$conn->query("insert into hiphop (choreography,performance,suitability,stage,total,group_num,judge_id,ranking)
	   values('$choreography_3','$performance_3','$suitability_3','$stage_3','$total3','$d3','$judge_id','$p3_rank')");		
 
$conn->query("insert into hiphop (choreography,performance,suitability,stage,total,group_num,judge_id,ranking)
	   values('$choreography_4','$performance_4','$suitability_4','$stage_4','$total4','$d4','$judge_id','$p4_rank')");	
 
 
 $conn->query("update judges set e6_stat='$stat' where judge_id='$judge_id'");	
