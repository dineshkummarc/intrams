...
$conn->query("insert into chorale (musical,visual,appropriateness,stage,total,group_num,judge_id,ranking)
	   values('$musical_1','$visual_1','$appropriateness_1','$stage_1','$total1','$d1','$judge_id','$p4_rank')");		
 
 


$conn->query("insert into chorale (musical,visual,appropriateness,stage,total,group_num,judge_id,ranking)
	   values('$musical_2','$visual_2','$appropriateness_2','$stage_2','$total2','$d2','$judge_id','$p2_rank')");		
 
 


$conn->query("insert into chorale (musical,visual,appropriateness,stage,total,group_num,judge_id,ranking)
	   values('$musical_3','$visual_3','$appropriateness_3','$stage_3','$total3','$d3','$judge_id','$p3_rank')");	
...
$conn->query("insert into chorale (musical,visual,appropriateness,stage,total,group_num,judge_id,ranking)
	   values('$musical_4','$visual_4','$appropriateness_4','$stage_4','$total4','$d4','$judge_id','$p4_rank')");	
 
 
 $conn->query("update judges set e5_stat='$stat' where judge_id='$judge_id'");	
