...
<header class="jumbotron subhead" id="overview">
  ...
  <div class="container">
   ...
   <thead>
   <th>Fullname</th>
    <th>Event(s) to Judge</th>
     <th>Actions</th>
   </thead>
   <tbody>
   
   <?php 	$query = $conn->query("select * from judges where type='Judge'") or die(mysql_error());
   ...
   <td><?php echo $row['fname']." ".$row['mname']." ".$row['lname']; ?></td>
         ...
         <?php if($row['e7']=="ok")
    {
     ...
     <td><a href="edit_judge.php?judge_id=<?php echo $row['judge_id'];?>" class="btn btn-success"> Edit</a> 
       <a href="delete_judge.php?judge_id=<?php echo $row['judge_id'];?>" class="btn btn-danger"> Delete</a></td>
   </tr>
   <?php } ?>
   </tbody>
   </table>
