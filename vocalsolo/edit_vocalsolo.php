<?php  include('../dbcon.php') ?>
 ...
 $english_query = $conn->query("select * from vocalsolo where judge_id = '$session_id' and singer_num='$d1'");
...
$english_query = $conn->query("select * from vocalsolo where judge_id = '$session_id' and singer_num='$d2'");
...
$english_query = $conn->query("select * from vocalsolo where judge_id = '$session_id' and singer_num='$d3'");
...
$english_query = $conn->query("select * from vocalsolo where judge_id = '$session_id' and singer_num='$d4'");
...
<form method="POST">
       ...
       <section id="download-bootstrap">
          <div class="page-header">
            <h1>Edit Vocal Solo - Visayan Folk Song</h1> 
...
$conn->query("update vocalsolo set tone='$tone_1',musicianship='$musicianship_1',diction='$diction_1',suitability='$suitability_1',stage='$stage_1',total='$total1',ranking='$p1_rank' where judge_id='$judge_id' and singer_num='$d1'");	
  
$conn->query("update vocalsolo set tone='$tone_2',musicianship='$musicianship_2',diction='$diction_2',suitability='$suitability_2',stage='$stage_2',total='$total2',ranking='$p2_rank' where judge_id='$judge_id' and singer_num='$d2'");	
 
$conn->query("update vocalsolo set tone='$tone_3',musicianship='$musicianship_3',diction='$diction_3',suitability='$suitability_3',stage='$stage_3',total='$total3',ranking='$p3_rank' where judge_id='$judge_id' and singer_num='$d3'");		
  
$conn->query("update vocalsolo set tone='$tone_4',musicianship='$musicianship_4',diction='$diction_4',suitability='$suitability_4',stage='$stage_4',total='$total4',ranking='$p4_rank' where judge_id='$judge_id' and singer_num='$d4'");	
