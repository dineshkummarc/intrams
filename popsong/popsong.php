...
$conn->query("insert into popsong (tone,musicianship,diction,suitability,style,stage,total,singer_num,judge_id,ranking)
	   values('$tone_1','$musicianship_1','$diction_1','$suitability_1','$style_1','$stage_1','$total1','$d1','$judge_id','$p1_rank')");		
 
$conn->query("insert into popsong (tone,musicianship,diction,suitability,style,stage,total,singer_num,judge_id,ranking)
	   values('$tone_2','$musicianship_2','$diction_2','$suitability_2','$style_2','$stage_2','$total2','$d2','$judge_id','$p2_rank')");		
 
$conn->query("insert into popsong (tone,musicianship,diction,suitability,style,stage,total,singer_num,judge_id,ranking)
	   values('$tone_3','$musicianship_3','$diction_3','$suitability_3','$style_3','$stage_3','$total3','$d3','$judge_id','$p3_rank')");		
 
$conn->query("insert into popsong (tone,musicianship,diction,suitability,style,stage,total,singer_num,judge_id,ranking)
	   values('$tone_4','$musicianship_4','$diction_4','$suitability_4','$style_4','$stage_4','$total4','$d4','$judge_id','$p4_rank')");		
 
 
 
 
 
 $conn->query("update judges set e4_stat='$stat' where judge_id='$judge_id'");	
