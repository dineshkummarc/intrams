...
else
{
 ...
 $conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_e_1','$diction_e_1','$suitability_e_1','$mastery_e_1','$presence_e_1','$total1','$d1','$type_e','$judge_id','$p1_rank')");	
 
 

 $conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_e_2','$diction_e_2','$suitability_e_2','$mastery_e_2','$presence_e_2','$total2','$d2','$type_e','$judge_id','$p2_rank')");	
 
 

$conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_e_3','$diction_e_3','$suitability_e_3','$mastery_e_3','$presence_e_3','$total3','$d3','$type_e','$judge_id','$p3_rank')");	
 
 


$conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_e_4','$diction_e_4','$suitability_e_4','$mastery_e_4','$presence_e_4','$total4','$d4','$type_e','$judge_id','$p4_rank')");	
 
 
 

$conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_f_1','$diction_f_1','$suitability_f_1','$mastery_f_1','$presence_f_1','$total_f_1','$d1','$type_f','$judge_id','$fp1_rank')");	
...
$conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_f_2','$diction_f_2','$suitability_f_2','$mastery_f_2','$presence_f_2','$total_f_2','$d2','$type_f','$judge_id','$fp2_rank')");	
 
 


$conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_f_3','$diction_f_3','$suitability_f_3','$mastery_f_3','$presence_f_3','$total_f_3','$d3','$type_f','$judge_id','$fp3_rank')");	
 
 
 

$conn->query("insert into declamation (interpretation,diction,suitability,mastery,stage,total,declaimer_num,type,judge_id,ranking)
	   values('$interpretation_f_4','$diction_f_4','$suitability_f_4','$mastery_f_4','$presence_f_4','$total_f_4','$d4','$type_f','$judge_id','$fp4_rank')");	
 
 
 $conn->query("update judges set e1_stat='$stat' where judge_id='$judge_id'");	
